...
namespace cad_gui {
	TexturedRenderable::TexturedRenderable(int texture_shader, GLuint texture, std::shared_ptr<cad_data::Feature> geo_ptr, glm::vec4 texture_tint, GLuint render_primative) 
		: cad_gui::Renderable(texture_shader, geo_ptr, render_primative), texture(texture),
